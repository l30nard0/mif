...
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo Running: pvd_prop_run "{\"type\": \"voice\"}" wget http://[2001:db8:2::1]/swtheme.mp3 -P $TMPDIR
$TESTAPPS/pvd_prop_run "{\"type\": \"voice\"}" wget http://[2001:db8:2::1]/swtheme.mp3 -P $TMPDIR
